package com.otoil.server.entities.treedoccard;
...
public class TreeDocCard extends Entity
{
    ...
    public static final String PROPERTYNAME_DCCRDKND_DCCRDKND_ID = "dccrdkndDccrdkndId";
    ...
    @Xml(name = "DCCRDKND_DCCRDKND_ID")
    private BigDecimal dccrdkndDccrdkndId;
    ...
    public void setDcmcrdDcmcrdId(BigDecimal dcmcrdDcmcrdId)
    {
        ...
        firePropertyChange(PROPERTYNAME_DCMCRD_DCMCRD_ID, oldValue,
            dcmcrdDcmcrdId);
    }
    
    public BigDecimal getDccrdkndDccrdkndId()
    {
        return dccrdkndDccrdkndId;
    }

    public void setDccrdkndDccrdkndId(BigDecimal dccrdkndDccrdkndId)
    {
        BigDecimal oldValue = this.dccrdkndDccrdkndId;
        this.dccrdkndDccrdkndId = dccrdkndDccrdkndId;
        firePropertyChange(PROPERTYNAME_DCCRDKND_DCCRDKND_ID, oldValue,
            dccrdkndDccrdkndId);
    }
